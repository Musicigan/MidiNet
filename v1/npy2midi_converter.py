...
import pretty_midi
#
# path = 'C:/Users/admin/PycharmProjects/StatML-Project/preprocessing' #path of numpy arrays
# piano_roll = np.load(path + '/TRKKJQV128F428B25B.npy')
# piano_roll = np.expand_dims(piano_roll.squeeze(), axis=0)
...
#
# destination = 'C:/Users/admin/PycharmProjects/StatML-Project'

#program_dict = {'Piano': 0, 'Drums': 0, 'Guitar': 24, 'Bass': 32, 'Strings': 48}

# program_nums = [0, 0, 24, 32, 48], is_drum = True # For multitrack
#
# program_num = [24]
#
# write_piano_rolls_to_midi(piano_roll, program_nums=program_num, is_drum=[False], filename=destination + '/test.mid',
#                           velocity=100, tempo=120.0, beat_resolution=24)
